...
const nav=[['overview','home','Overview'],['plan','plan','Action plan'],['documents','files','Documents'],['evidence','eye','Evidence review'],['letters','mail','Letters'],['memories','heart','Memories'],['exposure','shield','Privacy'],['ledger','clock','Activity'],['settings','settings','Settings']];
