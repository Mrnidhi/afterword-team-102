...
const files = ['dist/index.html','dist/app.html'];
let changed = false;
...
if(process.argv.includes('--check')) {
  if(changed){console.error('Run node scripts/version-assets.cjs before committing frontend changes.');process.exit(1);}
