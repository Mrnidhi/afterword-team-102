...
The site opens with a public landing page that explains the purpose of Afterword and links into the workspace through **Try the workspace**. The workspace remains available directly at `#overview`.
...
7. **Privacy** — storage and connection status, outreach/disclosure history, consent records and export.
